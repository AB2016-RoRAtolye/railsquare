WebsocketRails.setup do |config|
  ...
  if Rails.env.development?
    config.redis_options = {driver: :hiredis}
  else
    # config.redis_options = { username: ENV["REDISCLOUD_USERNAME"], password: ENV["REDISCLOUD_PASSWORD"], host: ENV["REDISCLOUD_HOST"], port: ENV["REDISCLOUD_PORT"], driver: :hiredis}
  end
